...
func allGames() []gameCard {
	return []gameCard{
		...
		},
		{
			...
			Title:       "Soma Rápida",
			ShortTitle:  "Soma",
			Description: "Um desafio de contas curtas contra o relógio: resolva o máximo que conseguir antes do tempo acabar.",
			Intro:       "Resolva operações simples em sequência, mantenha o ritmo e tente superar sua melhor pontuação.",
			URL:         "/jogos/soma-rapida",
			Status:      "jogável",
			Difficulty:  "leve",
			Duration:    "1 min",
			Accent:      "blue",
			Tags:        []string{"matemática", "tempo", "foco"},
			Instructions: []string{
				"Clique em começar para iniciar uma rodada de 30 segundos.",
				"Digite a resposta da operação e envie pelo botão ou Enter.",
				"Acertos somam pontos e erros quebram a sequência.",
			},
		},
		{
